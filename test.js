...
function get_emoji(emojip, sname) {
  var Lmoji = {
    ...
    "🇬🇹": ["🇬🇹", "危地马拉", " GT "],
    "🇬🇺": ["🇬🇺", "关岛"],
    "🇭🇰": ["🇭🇰", "HK", "hk", "Hongkong", "Hong Kong", "HongKong", "HONG KONG", "香港", "深港", "沪港", "呼港", "HKT", "HKBN", "HGC", "CMI", "穗港", "京港", "港"],
    ...
    "🇹🇹": ["🇹🇹", "突尼斯"],
    "🇹🇼": ["🇹🇼", "🇼🇸", "TW", "Taiwan", "TAIWAN", "台湾", "台北", "台中", "新北", "彰化", "CHT", "台", "臺", "HINET"],
    "🇺🇦": ["烏克蘭", "乌克兰", "Ukraine"],
