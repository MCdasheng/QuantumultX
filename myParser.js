...
function get_emoji(emojip, sname) {
 ...
 // "🇨🇳": ["🇨🇳", "CN", "CHN", "China", "CHINA", "回国", "中国", "中國", "江苏", "北京", "上海", "广州", "深圳", "杭州", "徐州", "青岛", "宁波", "镇江"],
    ...
    "🇭🇷": ["🇭🇷", "HR", "克罗地亚", "克羅埃西亞", "萨格勒布", "札格瑞布", "Croatia", "Zagreb"],
    "🇭🇺": ["🇭🇺", "匈牙利", "Hungary"],
    "🇮🇩": ["🇮🇩", "ID", "IDN", "Indonesia", "印尼", "印度尼西亚", "印度尼西亞", "雅加达", "雅加達"],
    "🇮🇪": ["🇮🇪", "Ireland", "IRELAND", "IE", "爱尔兰", "愛爾蘭", "都柏林"],
    "🇮🇱": ["🇮🇱", "Israel", "以色列"],
    "🇮🇲": ["马恩岛", "馬恩島", "Isle of Man", "Mannin"],
    "🇮🇳": ["🇮🇳", "IN", "India", "IND", "INDIA", "印度", "孟买", "Mumbai"],
    "🇮🇶": ["🇮🇶", "IQ", "伊拉克"],
    "🇮🇷": ["🇮🇷", "IR", "伊朗", "Iran"],
    ...
    "🇰🇭": ["🇰🇭", "KH", "柬埔寨", "金边", "金邊", "Cambodia"],
    "🇰🇵": ["🇰🇵", "KP", "朝鲜", "北韩", "北韓", "North Korea"],
    "🇰🇷": ["🇰🇷", "KR", "Korea", "KOR", "韩国", "首尔", "首爾", "韓", "春川", "仁川"],
    ...
    "🇹🇳": ["突尼斯", "Tunisia"],
    "🇹🇷": ["🇹🇷", "TR", "TR ", "TR-", "TR_", "TUR", "Turkey", "土耳其", "伊斯坦布尔"],
    "🇹🇹": ["🇹🇹", "TT", "突尼斯"],
