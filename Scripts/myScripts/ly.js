...
脚本功能: 获取凌云试用订阅(1G/1d)
注: 关闭代理运行
33 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/ly.js, tag=凌云订阅, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Final.png, enabled=true
*/

const auth = "ly_auth";
const tagName = "凌云";
const register_url = `https://console.ly520.me/api/v1/passport/auth/register`;
const subscribe_url = `https://console.ly520.me/api/v1/user/getSubscribe`;
