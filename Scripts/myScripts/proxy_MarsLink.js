/*
脚本功能: 获取MarsLink试用订阅(5G/d)
节点地区: 港、台、日、美、新、韩
33 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/proxy_MarsLink.js, tag=MarsLink订阅, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Final.png, enabled=true
*/

const tagName = "MarsLink";
const domain = "https://ss.marslink.org";
