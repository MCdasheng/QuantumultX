...
⏰定时任务:
[task local]
30 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/qidian_2.js, tag=起点读书2, enabled=true
📦BoxJs地址:
https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/mcdasheng.boxjs.json
@params: 
  "qd_headers"
  "qd_taskId_2"
  "qd_timeout": 间隔时间, 默认20s, 不怕黑号可以在BoxJs中修改为0, 不间隔
*/

const $ = new Env("起点读书");

$.headers = $.getdata("qd_headers");
$.taskId = $.getdata("qd_taskId_2");
