...
🎯重写脚本:
[rewrite local]
^https:\/\/fz-gateway\.waimaimingtang\.com\/api\/api\/v2\/user\/api_user_sign_in script-request-header wm.cookie.js
[MITM]
hostname = fz-gateway.waimaimingtang.com
⏰定时任务:
[task local]
30 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/wm.js, tag=外麦, enabled=true
📦BoxJs地址:
...
var session = $.getdata("wm_session");
