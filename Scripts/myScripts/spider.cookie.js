/* 
脚本功能: Spider Proxy 授权数量增加
脚本步骤: 
    随便添加一个重写规则
    随便授权一个设备
    删除该设备, 弹出通知信息即可执行定时任务
@tips:
    只能用于主设备!
🎯重写脚本:
[rewrite local]
    http\:\/\/api\.zhugeculture\.com\/api\/device\/del url script-request-body https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/spider.cookie.js
[MITM]
    hostname = api.zhugeculture.com
⏰定时任务:
[task local]
    30 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/spider.js,  tag=Spider, enabled=true
📦BoxJs地址:
