...
注: 关闭代理运行
33 10 * * * https://raw.githubusercontent.com/MCdasheng/QuantumultX/main/Scripts/myScripts/dgy.js, tag=大哥云订阅, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Final.png, enabled=true
*/

const auth = "dgy_auth";
const tagName = "大哥云"
const register_url = `https://aa66aa.com/api/v1/passport/auth/register`;
const subscribe_url = `https://aa66aa.com/api/v1/user/getSubscribe`;
